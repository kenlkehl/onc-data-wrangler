...
field_mappings:
  <category_name>:                 # e.g. diagnosis, biomarker, treatment; from <source_file.csv>
    - source: <SOURCE_COLUMN>
      ...
      value_map:                   # Optional value remapping
        OLD_VALUE: new_value
    # IMPORTANT: Each category value MUST be a pure list of mappings.
    # Do NOT add extra keys like "source_file:" at the list level — this
    # produces invalid YAML.  Note the source file in a comment instead.
