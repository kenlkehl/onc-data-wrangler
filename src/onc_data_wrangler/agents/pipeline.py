...
def run_pipeline(config_path: str, stages: list[str] = None, resume: bool = False, progress=None):
    ...
    Args:
        ...
        progress: Optional PipelineRun object for progress tracking (web UI).
    """
    ...
    for stage in stages:
        ...
        try:
            ...
            if progress is not None:
                progress.fail_stage(stage, str(exc))
            raise
...
def _run_extraction(config: ProjectConfig, resume: bool = False):
    ...
    try:
        ...
        extractor = create_extractor(
            ...
            items_per_call=ext_config.items_per_call,
        )
